...
sleep 1
gnome-terminal --geometry 70x33+47--10 -x bash -c "/home/interface/ngrok/iosuzy_ngrok/linux/ngrok -config=/home/interface/ngrok/iosuzy_ngrok/linux/ngrok.cfg start sgoly3" &
sleep 2