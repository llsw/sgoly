...
function CMD.ranklist(fd,mes)
	...
	--      local bool3,rqs3=sgoly_tool.getRankFromRedis(mes.NAME,tonumber(req1.serialWinNum), "serialWinNum",c)
	-- 	    printI("this is rank,%s",mes.NAME)
 ...
 --     local bool4,rqs4=sgoly_tool.getRankFromRedis(mes.NAME,tonumber(req1.winMoney), "winMoney",c)
	--     printI("this is rank,%s",mes.NAME)
